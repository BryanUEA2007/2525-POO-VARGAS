...
def mostrar_menu():
    ...
    unidades = {
        '1': 'PARCIAL_1/Semana 2/abstraccion.py',
        '2': 'PARCIAL_1/Semana 3/p_tradicional.py',
        '3': 'PARCIAL_1/Semana 4/poo_vidareal.py',
        '4': 'PARCIAL_1/Semana 5/area.py',
        '5': 'PARCIAL_1/Semana 6/tarea_s6.py',
        '6': 'PARCIAL_1/Semana 7/tarea_constructores.py'
    }
